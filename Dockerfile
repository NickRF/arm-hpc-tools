...
RUN bash -c "wget -q -O- https://developer.arm.com/-/media/Files/downloads/hpc/arm-allinea-studio/19-1/Ubuntu16.04/Arm-Compiler-for-HPC_19.1_Ubuntu_16.04_aarch64.tar | tar jx && ( [ -e ARM-Compiler-for-HPC_*.tar* ] && tar -xf ARM-Compiler-for-HPC_*.tar*; true ) && ./ARM-Compiler-for-HPC*/*.sh --accept; rm -rf /tmp/*"
